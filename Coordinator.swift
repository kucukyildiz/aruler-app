    ...
    @objc func handleTap(_ recognizer: UITapGestureRecognizer) {
        ...
        if let result = results.first {
            ...
            if startAnchor == nil {
                ...
                let ball = ModelEntity(mesh: MeshResource.generateSphere(radius: 0.01), materials: [SimpleMaterial(color: .green,isMetallic: true)])
                ...
                measurementButton.setTitle(String(format: "%.2f metre", distance), for: .normal)
